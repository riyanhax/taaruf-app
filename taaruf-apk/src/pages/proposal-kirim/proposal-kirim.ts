...
@IonicPage()
@Component({
  selector: 'page-proposal-kirim',
  templateUrl: 'proposal-kirim.html',
})
export class ProposalKirimPage {
  responseData:any;
  list:any=false;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private toastCtrl: ToastController
    , private requestProvider: RequestProvider,public ratingProvider: RatingProvider){
  	this.listReq();
  }
  ...
  private listReq():void{
    ...
    var params = 'appproposal/sentlist?api_key='+this.userData.remember_token+'&page='+this.page;
    ...
    console.log('page: '+this.page+'last page: '+this.last_page);
    var newListData:any;
